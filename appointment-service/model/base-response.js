...
const ErrorCodes = {
    ...
    REFRESH_VALIDITY_EXPIRED: { status: 401, code: 103, message: 'Refresh validity expired' },
    INVALID_CREDENTIALS: { status: 401, code: 104, message: 'Invalid credentials' },
    ...
    INACTIVE_USER: { status: 401, code: 104, message: 'Your account has been deactivated by the admin' },
    INVALID_TOKEN: { status: 401, code: 105, message: 'Invalid token' },
